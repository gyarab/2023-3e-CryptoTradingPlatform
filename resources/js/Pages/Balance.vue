  ...
  <AuthenticatedLayout>
    ...
    <div class="py-12 text-primarytext">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-bg mb-5 overflow-hidden shadow-sm shadow-primarytext/20 sm:rounded-lg">
          <div class="p-6">
            <p class="text-xl font-semibold">Favourite Crypto Currencies:</p> <br>
            <div class="text-xl mx-" v-for="listedCrypto in favouriteCryptoCurrencies">
              <div
                class="p-6 bg-bg mb-5 overflow-hidden shadow-sm shadow-purple-500/50 hover:shadow-purple-500 sm:rounded-lg">
              ...
              <table class="border-none min-w-full text-left text-sm font-light rounded-lg bg-bg text-primarytext">
                ...
                <tbody>
                  <tr v-for="trade in userTrades">
                    ...
                    <td scope="row" class="px-6 py-4 text-red-600 border-border border-b hidden sm:table-cell" v-else>
                      Sell
                    </td>
                    ...
                    <td scope="row" class="px-6 py-4 text-red-600 border-border border-b" v-else>
                      {{ formatNumber(trade['crypto_amount']) }}
                    </td>
                    <td scope="row" class="px-6 py-4 border-border border-b">
