<template>
  <div class="max-w-lg mx-auto mt-6 p-4 bg-white shadow-md rounded-lg">
    ...
    <label for="usdAmount" class="block text-sm font-medium text-gray-700" :class="{ 'mt-2': mode === 'sell' }">Amount in USD:</label>
    ...
    <label for="cryptoAmount" class="block text-sm font-medium text-gray-700" :class="{ 'mt-2': mode === 'buy' }">Equivalent Amount:</label>
